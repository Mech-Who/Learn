...
基于类装饰器的实现，必须实现 \_\_call\_\_ 和 \_\_init\_\_两个内置函数。
...
- \_\_init\_\_ ：不再接收被装饰函数，而是接收传入参数。
- \_\_call\_\_ ：接收被装饰函数，实现装饰逻辑。
...
除函数之外，类也可以是 callable 对象，只要实现了**call** 函数（上面几个例子已经接触过了）。
...
- [恶补了 Python 装饰器的六种写法，你随便问~](https://mp.weixin.qq.com/s?__biz=Mzg2OTg3MTU2OQ==&mid=2247506040&idx=1&sn=376e4201168ebeaadf49c82e412a8c94&source=41#wechat_redirect)
