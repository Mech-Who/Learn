...
/*-----------------------------------------------
              @(target):= _palindrome.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__palindrome

#else
#  define SWIG_init    init_palindrome

#endif
#define SWIG_name    "_palindrome"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_is_palindrome(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "is_palindrome" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  result = (int)is_palindrome(arg1);
...
static PyMethodDef SwigMethods[] = {
	 { "is_palindrome", _wrap_is_palindrome, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
